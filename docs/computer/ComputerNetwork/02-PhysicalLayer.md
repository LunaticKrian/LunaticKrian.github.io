...
![img.png](02-PhysicalLayer.assets/img.png)
...
![img_1.png](02-PhysicalLayer.assets/img_1.png)
...
![img_2.png](02-PhysicalLayer.assets/img_2.png)

</div>

信道极限容量：信号波形在实际信道传输时，会受到带宽受限、噪声、干扰等引起失真。

![img_3.png](02-PhysicalLayer.assets/img_3.png)
...
1. 信道的带宽或信道的信噪比(S/N)越大，信息极限传输速率越高，若W或S/N没有上限，则C没有上限（实际不可能）
2. 只要信息传输速率低于信道极限信息传输速率，则一定可以找到方法确保数据的无差错传输
...
![img_4.png](02-PhysicalLayer.assets/img_4.png)
...
![img_5.png](02-PhysicalLayer.assets/img_5.png)
...
![img_6.png](02-PhysicalLayer.assets/img_6.png)
...
- E1取样8000次/s 每个码元代表8位bit E1 采用时分复用技术 32路同时传输。 `8 * 8000 * 32 = 2.048Mb/s`

- T1只有24路同时传播，且有控制信号。`8 * 8000 * 24 + 8K = 1.544Mb/s(8K表示控制信号)`
...
![img_7.png](02-PhysicalLayer.assets/img_7.png)
