...
![image-20250821001343539](01-ComputerNetworkArchitecture.assets/image-20250821001343539.png)
...
计算机网络的性能指标用来从不同的方面来度量计算机网络的性能。常用的性能指标有7个： **速率、带宽、吞吐量、时延、时延带宽积、往返时间** （Round-Trip Time，简称 RTT）、 **利用率**
